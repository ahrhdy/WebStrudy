...
function getExcelList(){
	//엑셀 다운로드 데이터 정의
	listBind.setExcelColumn("USER_ID,USER_NAME,EMAIL,MOBILE,INS_DATE");
	
	//엑셀파일 헤더 설정
	listBind.setExcelLabel("아이디,이름,이메일,휴대전화,등록일자");
            ...
            <div class="container-fluid">
               ...
               <div class="row">
					...
					<div class="col-lg-6">
						<h2>GRID 조회
							<span class="fr"> 
								<button class="btn btn-sm btn-success" onclick="getExcelList();">엑셀 다운로드</button>					
							</span>			
						</h2>
